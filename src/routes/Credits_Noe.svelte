<section id="credits_Noe">
    <div>
        <h2>NOÉ DELIN</h2>
        <p>
        J'ai conçu le site sur lequel vous vous trouvez.
        </p>
    </div>
    <div>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" id="blobSvg" style="opacity: 1;"><image x="0" y="0" width="100%" height="100%" clip-path="url(#shape)" href="/assets/noe.png" preserveAspectRatio="none"></image>
        <defs>
    ...
    <style>
      ...
      #credits_Noe > div:last-of-type > h2 {
        width: max-content;
      }
